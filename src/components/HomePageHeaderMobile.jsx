            ...
            <div className="menu_mobile--item dropdown dropdown__menu-tool">
              ...
              <div className="dropdown-menu menu-tool">
                <div className="dropdown-item"><a href="###"><img src="../../assets/img/Group 1569.png" alt="" /><span className="menu-tool--text">
                  Tính toán khoản
                        vay</span></a></div>
                <div className="dropdown-item"><a href="###"><img src="../../assets/img/baseline-insert_chart-24px.png" alt="" /><span className="menu-tool--text">Tính toán hiệu quả dự
                        án</span></a></div>
...
export default HomePageHeaderMobile;
